  ...
  return (
    <div className="legal-page">
      ...
      <main className="legal-content">
        ...
        <section><h2>Inteligência artificial</h2><p>Conteúdos do currículo e das vagas podem ser enviados ao Google Gemini para extração estruturada, geração de embeddings, análise de compatibilidade e preparação de materiais. Em caso de indisponibilidade, limite ou erro temporário do Gemini, textos necessários à geração solicitada podem ser processados pela Groq como contingência. PDFs, arquivos e embeddings não são enviados à Groq. O VagaMatch não deve usar esses resultados para tomar, sozinho, uma decisão final de contratação.</p></section>
        <section><h2>Compartilhamento e operadores</h2><p>O serviço utiliza infraestrutura ou integrações de Supabase, Vercel, Google Gemini, Groq, Telegram, Stripe e Mercado Pago conforme a funcionalidade utilizada. Contratos, regiões de processamento, subprocessadores e mecanismos de transferência internacional ainda precisam de validação formal.</p></section>
